.. title:: Managing controls with JS in Plumsail Forms (public forms)
        ...
        -   Property that specifies if user can draw on canvas or not. Takes and returns only *true* and *false* values.
            ...
            *Examples:*
            ...
            .. code-block:: javascript
                ...
                fd.control('Signature0').disabled;
                fd.control('Signature0').disabled = true;
                fd.control('Signature0').disabled = false;
