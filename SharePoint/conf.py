...
html_baseurl = 'https://plumsail.com/docs/forms-sp/' #for sitemap
...
latex_documents = [
    (master_doc, 'Forms.tex', 'Forms Documentation',
     'Plumsail', 'manual'),
]
...
man_pages = [
    (master_doc, 'forms', 'Forms Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Forms', 'Forms Documentation',
     author, 'Forms', 'One line description of project.',
     'Miscellaneous'),
]
